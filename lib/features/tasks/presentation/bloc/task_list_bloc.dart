...
class TaskListBloc extends Bloc<TaskListEvent, TaskListState> {
  ...
  void _onUpdateSearchQuery(UpdateSearchQuery event, Emitter<TaskListState> emit) {
  ...
  void _onUpdateStatusFilter(UpdateStatusFilter event, Emitter<TaskListState> emit) {
    emit(TaskListInitial(
      tasks: state.tasks,
      page: state.page,
      hasMore: state.hasMore,
  ...
  void _onUpdatePriorityFilter(UpdatePriorityFilter event, Emitter<TaskListState> emit) {
    emit(TaskListInitial(
      tasks: state.tasks,
      page: state.page,
      hasMore: state.hasMore,
  ...
  void _onUpdateDateFilterType(UpdateDateFilterType event, Emitter<TaskListState> emit) {
    emit(TaskListInitial(
      tasks: state.tasks,
      page: state.page,
      hasMore: state.hasMore,
  ...
  void _onLocalTaskCreated(LocalTaskCreated event, Emitter<TaskListState> emit) {
  ...
  void _onLocalTaskUpdated(LocalTaskUpdated event, Emitter<TaskListState> emit) {
    final updatedList = List<Object>.from(state.tasks).cast<dynamic>();
  ...
  Future<void> _onSyncQueueTriggered(SyncQueueTriggered event, Emitter<TaskListState> emit) async {
    emit(TaskListLoaded(
      tasks: state.tasks,
      page: state.page,
      hasMore: state.hasMore,
