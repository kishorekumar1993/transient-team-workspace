  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Search', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 20)),
      ),
      body: Column(
        children: [
          // Modern Search Box
                ...
                children: [
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: TextStyle(color: theme.hintColor, fontSize: 13.5),
                  ...
                  if (_localQuery.isNotEmpty)
                    GestureDetector(
                      ...
                      child: Icon(Icons.cancel_rounded, size: 18, color: theme.hintColor),
                    ),
                ],
              ),
            ),
                ...
                if (_localQuery.isEmpty) {
                  return Center(
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Icon(Icons.search_rounded, size: 56, color: AppTheme.primaryColor.withOpacity(0.2)),
                      const SizedBox(height: 16),
                      Text('Search your tasks', style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w800, fontSize: 18)),
                      const SizedBox(height: 4),
                      Text('Type above to search across titles and descriptions.',
                          textAlign: TextAlign.center, style: theme.textTheme.bodyMedium?.copyWith(fontSize: 13)),
                    ]),
                  );
                }
                ...
                if (tasks.isEmpty) {
                  return Center(
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      const SizedBox(height: 4),
                      Text('Try searching with different keywords.', style: theme.textTheme.bodyMedium?.copyWith(fontSize: 13)),
                    ]),
                  );
                }
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w700, fontSize: 13, color: AppTheme.primaryColor),
                      ),
                    ),
                    Expanded(
