                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const CreateEditTaskPage(),
                      ),
                    ),
                ...
                builder: (context, state) {
                  ...
                  return TabBarView(
                    ...
                    children: List.generate(3, (tabIdx) {
                      final tabFiltered = state.tasks
                          .where((t) => t.status == _tabStatus(tabIdx))
                          .toList();
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (_, i) =>
                            _taskCard(theme, isDark, tabFiltered[i]),
                      );
                    }),
                  );
                },
