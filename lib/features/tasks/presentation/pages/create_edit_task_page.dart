                ...
                if (state is TaskFormSuccess) {
                  if (state.isEdit) {
                    context.read<TaskListBloc>().add(
                      LocalTaskUpdated(state.task),
                    );
                  } else {
                    context.read<TaskListBloc>().add(
                      LocalTaskCreated(state.task),
                    );
                  }
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText:
                                        'e.g. Set up Git repositories and branches',
                                    prefixIcon: Icon(
                                ...
                                TextFormField(
                                  ...
                                  decoration: const InputDecoration(
                                    hintText:
                                        'Describe what needs to be done, expected outcomes, and any context...',
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    'Provide enough context for the assignee to understand the task.',
                                    style: TextStyle(
                                      fontSize: 11,
                                      color: theme.hintColor,
                                    ),
